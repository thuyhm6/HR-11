...
import { ApplyDetailResponse, SyAffirmEmailDto } from './view-approvaled-email.model';

const API_BASE = '/ess/infoApply/api/approvaledEmail';
...
/**
 * Gọi lại nguyên các API JSON đã có sẵn ở backend mà viewApprovaledEmail.html (Thymeleaf) và 3 modal
 * chi tiết dùng chung (viewApprovaledOt/viewApprovaledLeave/viewAttendanceEx) đang dùng - không đổi backend.
 */
@Injectable({ providedIn: 'root' })
export class ViewApprovaledEmailService {
