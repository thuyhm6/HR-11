...
/** Tương ứng với EvsConfirmTarget1Dto.java (1 dòng trong danh sách nhân viên cần xác nhận). */
...
/** Tương ứng với DataTablesResponse<T>.java (GET .../confirmTarget1/objectList - phân trang server-side). */
...
/** Payload gửi lên POST .../confirmTarget1/confirm - flag: '1'=Xác nhận, '0'=Từ chối. */
