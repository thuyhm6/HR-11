/** Tương ứng với response GET /ess/infoApply/api/noticeedEmail/list (SyAffirmEmailDto). */
...
/** Loại đơn suy ra từ affirmUrl - đúng vneOpenDetailModal() bản gốc (so khớp chuỗi con trong URL). */
