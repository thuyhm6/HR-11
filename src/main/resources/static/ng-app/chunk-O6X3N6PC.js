...
// src/app/view-approvaled-email/view-approvaled-email.service.ts
var API_BASE = "/ess/infoApply/api/approvaledEmail";
...
var ViewApprovaledEmailService = class _ViewApprovaledEmailService {
  constructor(http) {
    this.http = http;
  }
  http;
  ...
  static \u0275fac = function ViewApprovaledEmailService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ViewApprovaledEmailService)(\u0275\u0275inject(HttpClient));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ViewApprovaledEmailService, factory: _ViewApprovaledEmailService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ViewApprovaledEmailService, [{
    type: Injectable,
    args: [{ providedIn: "root" }]
  }], () => [{ type: HttpClient }], null);
})();

// src/app/view-approvaled-email/view-approvaled-email.component.ts
var _c0 = () => ({ "max-height": "75vh", "overflow-y": "auto" });
function ViewApprovaledEmailComponent_nz_option_15_Template(rf, ctx) {
  if (rf & 1) {
...
function ViewApprovaledEmailComponent_nz_alert_22_Template(rf, ctx) {
  if (rf & 1) {
...
function ViewApprovaledEmailComponent_tr_43_a_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 32);
    \u0275\u0275listener("click", function ViewApprovaledEmailComponent_tr_43_a_4_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r4);
...
function ViewApprovaledEmailComponent_tr_43_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
...
function ViewApprovaledEmailComponent_tr_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 29);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td");
    \u0275\u0275template(4, ViewApprovaledEmailComponent_tr_43_a_4_Template, 2, 1, "a", 30)(5, ViewApprovaledEmailComponent_tr_43_ng_template_5_Template, 1, 1, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
...
function ViewApprovaledEmailComponent_tr_44_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(3, 1, "vaed.msg.noData", "Kh\xF4ng c\xF3 d\u1EEF li\u1EC7u"));
  }
}
function ViewApprovaledEmailComponent_ng_template_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
    \u0275\u0275pipe(1, "translate");
  }
...
function ViewApprovaledEmailComponent_ng_container_48_nz_alert_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "nz-alert", 28);
  }
  if (rf & 2) {
...
function ViewApprovaledEmailComponent_ng_container_48_ng_container_2_tr_42_Template(rf, ctx) {
  if (rf & 1) {
...
function ViewApprovaledEmailComponent_ng_container_48_ng_container_2_tr_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 29);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function ViewApprovaledEmailComponent_ng_container_48_ng_container_2_ng_container_72_Template(rf, ctx) {
  if (rf & 1) {
...
function ViewApprovaledEmailComponent_ng_container_48_ng_container_2_ng_template_73_Template(rf, ctx) {
  if (rf & 1) {
...
function ViewApprovaledEmailComponent_ng_container_48_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(42, ViewApprovaledEmailComponent_ng_container_48_ng_container_2_tr_42_Template, 4, 4, "tr", 24)(43, ViewApprovaledEmailComponent_ng_container_48_ng_container_2_tr_43_Template, 15, 7, "tr", 23);
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275text(71);
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275template(72, ViewApprovaledEmailComponent_ng_container_48_ng_container_2_ng_container_72_Template, 40, 34, "ng-container", 34)(73, ViewApprovaledEmailComponent_ng_container_48_ng_container_2_ng_template_73_Template, 34, 29, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementStart(75, "div", 47)(76, "button", 48);
    \u0275\u0275listener("click", function ViewApprovaledEmailComponent_ng_container_48_ng_container_2_Template_button_click_76_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function ViewApprovaledEmailComponent_ng_container_48_ng_template_3_div_0_Template(rf, ctx) {
  if (rf & 1) {
...
function ViewApprovaledEmailComponent_ng_container_48_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ViewApprovaledEmailComponent_ng_container_48_ng_template_3_div_0_Template, 3, 4, "div", 52);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function ViewApprovaledEmailComponent_ng_container_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, ViewApprovaledEmailComponent_ng_container_48_nz_alert_1_Template, 1, 1, "nz-alert", 18)(2, ViewApprovaledEmailComponent_ng_container_48_ng_container_2_Template, 79, 70, "ng-container", 34)(3, ViewApprovaledEmailComponent_ng_container_48_ng_template_3_Template, 1, 1, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
var I18N_KEYS = [
  "vaed.search.title",
  "vaed.search.applyType",
  "vaed.search.applyType.all",
  "vaed.search.applyType.ot",
  "vaed.search.applyType.leave",
  "vaed.search.applyType.anomaly",
  "vaed.btn.search",
  "vaed.col.no",
  "vaed.col.title",
  "vaed.col.applyPerson",
  "vaed.col.updateDate",
  "vaed.col.affirmStatus",
  "vaed.msg.noData",
  "vaed.msg.loadError",
  "common.close",
  "common.stt",
...
var APPLY_TYPE_OPTIONS = [
  { value: "31", labelKey: "vaed.search.applyType.ot", fallback: "T\u0103ng ca" },
  { value: "21", labelKey: "vaed.search.applyType.leave", fallback: "Ngh\u1EC9 ph\xE9p" },
  { value: "218197", labelKey: "vaed.search.applyType.anomaly", fallback: "Ngh\u1EC9 b\u1EA5t th\u01B0\u1EDDng" }
];
var STATUS_COLOR = {
  "14014309": "green",
  "14014310": "red",
...
var ViewApprovaledEmailComponent = class _ViewApprovaledEmailComponent {
  ...
  loadList() {
    ...
    this.api.getList().subscribe({
      ...
      error: () => {
        this.errorMessage.set(this.i18n.t("vaed.msg.loadError", "L\u1ED7i t\u1EA3i d\u1EEF li\u1EC7u"));
        this.allRows = [];
  ...
  static \u0275fac = function ViewApprovaledEmailComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ViewApprovaledEmailComponent)(\u0275\u0275directiveInject(ViewApprovaledEmailService), \u0275\u0275directiveInject(I18nService), \u0275\u0275directiveInject(NzMessageService), \u0275\u0275directiveInject(ActivatedRoute));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ViewApprovaledEmailComponent, selectors: [["app-view-approvaled-email"]], decls: 49, vars: 53, consts: [["vaedTable", ""], ["vaedTotalTpl", ""], ["plainTitle", ""], ["detailLoadingTpl", ""], ["leaveInfoTpl", ""], [1, "row"], [1, "col-12"], [1, "mb-3"], [1, "row", "g-3", 3, "ngSubmit"], [1, "col-md-4"], [1, "form-label"], ["nz-input", "", "name", "titleFilter", 3, "ngModelChange", "ngModel"], [1, "col-md-3"], ["name", "applyTypeFilter", "nzAllowClear", "", 1, "w-100", 3, "ngModelChange", "ngModel", "nzPlaceHolder"], [3, "nzValue", "nzLabel", 4, "ngFor", "ngForOf"], [1, "col-md-5", "d-flex", "align-items-end", "justify-content-end", "gap-2", "flex-wrap"], ["nz-button", "", "nzType", "primary", "type", "submit"], [1, "bx", "bx-search"], ["nzType", "error", "class", "mb-3", 3, "nzMessage", 4, "ngIf"], [1, "table-nowrap", 3, "nzData", "nzLoading", "nzPageSize", "nzShowSizeChanger", "nzPageSizeOptions", "nzShowTotal"], ["nzWidth", "60px", 1, "text-center"], ["nzWidth", "20%", 1, "text-center"], ["nzWidth", "12%", 1, "text-center"], [4, "ngFor", "ngForOf"], [4, "ngIf"], ["nzWidth", "70vw", 3, "nzOnCancel", "nzVisible", "nzTitle", "nzBodyStyle", "nzFooter"], [4, "nzModalContent"], [3, "nzValue", "nzLabel"], ["nzType", "error", 1, "mb-3", 3, "nzMessage"], [1, "text-center"], ["href", "javascript:void(0)", 3, "click", 4, "ngIf", "ngIfElse"], [3, "nzColor"], ["href", "javascript:void(0)", 3, "click"], ["colspan", "5", 1, "text-center", "text-muted", "py-3"], [4, "ngIf", "ngIfElse"], [1, "table-responsive", "mb-3"], [1, "table", "table-bordered", "table-sm", "align-middle", "mb-0"], [1, "table-light", "text-center", 2, "width", "160px"], [1, "table-light", "text-center"], [1, "table-responsive", "mb-4"], [2, "width", "50px"], [2, "width", "90px"], [2, "width", "110px"], [2, "width", "170px"], [2, "width", "120px"], [1, "fw-bold", "mb-2"], [1, "table-light", "text-center", 2, "width", "100px"], [1, "d-flex", "justify-content-end", "mt-3"], ["nz-button", "", "type", "button", 3, "click"], ["colspan", "7", 1, "text-center", "text-muted"], [1, "table-responsive"], [2, "width", "140px"], ["class", "text-center text-muted py-3", 4, "ngIf"], [1, "text-center", "text-muted", "py-3"]], template: function ViewApprovaledEmailComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "div", 5)(1, "div", 6)(2, "nz-card", 7)(3, "form", 8);
      \u0275\u0275listener("ngSubmit", function ViewApprovaledEmailComponent_Template_form_ngSubmit_3_listener() {
        return ctx.search();
      });
      ...
      \u0275\u0275twoWayListener("ngModelChange", function ViewApprovaledEmailComponent_Template_input_ngModelChange_8_listener($event) {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275pipe(14, "translate");
      \u0275\u0275twoWayListener("ngModelChange", function ViewApprovaledEmailComponent_Template_nz_select_ngModelChange_13_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.applyTypeFilter, $event) || (ctx.applyTypeFilter = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275template(15, ViewApprovaledEmailComponent_nz_option_15_Template, 2, 5, "nz-option", 14);
      \u0275\u0275elementEnd();
      \u0275\u0275controlCreate();
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275template(22, ViewApprovaledEmailComponent_nz_alert_22_Template, 1, 1, "nz-alert", 18);
      ...
      \u0275\u0275template(43, ViewApprovaledEmailComponent_tr_43_Template, 14, 7, "tr", 23)(44, ViewApprovaledEmailComponent_tr_44_Template, 4, 4, "tr", 24);
      \u0275\u0275elementEnd();
      \u0275\u0275template(45, ViewApprovaledEmailComponent_ng_template_45_Template, 2, 5, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(47, "nz-modal", 25);
      \u0275\u0275listener("nzOnCancel", function ViewApprovaledEmailComponent_Template_nz_modal_nzOnCancel_47_listener() {
        return ctx.closeDetail();
      });
      \u0275\u0275template(48, ViewApprovaledEmailComponent_ng_container_48_Template, 5, 3, "ng-container", 26);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      const vaedTable_r15 = \u0275\u0275reference(24);
      const vaedTotalTpl_r16 = \u0275\u0275reference(46);
      \u0275\u0275advance(6);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(7, 25, "vaed.search.title", "Ti\xEAu \u0111\u1EC1"));
      \u0275\u0275advance(2);
      \u0275\u0275twoWayProperty("ngModel", ctx.titleFilter);
      \u0275\u0275control();
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(12, 28, "vaed.search.applyType", "Lo\u1EA1i \u0111\u01A1n"));
      \u0275\u0275advance(2);
      \u0275\u0275twoWayProperty("ngModel", ctx.applyTypeFilter);
      \u0275\u0275property("nzPlaceHolder", \u0275\u0275pipeBind2(14, 31, "vaed.search.applyType.all", "-- T\u1EA5t c\u1EA3 --"));
      \u0275\u0275control();
      \u0275\u0275advance(2);
      \u0275\u0275property("ngForOf", ctx.applyTypeOptions);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(20, 34, "vaed.btn.search", "Tra c\u1EE9u"), " ");
      \u0275\u0275advance(3);
      \u0275\u0275property("ngIf", ctx.errorMessage());
      \u0275\u0275advance();
      \u0275\u0275property("nzData", ctx.displayRows())("nzLoading", ctx.loading())("nzPageSize", 25)("nzShowSizeChanger", true)("nzPageSizeOptions", ctx.pageSizeOptions)("nzShowTotal", vaedTotalTpl_r16);
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(29, 37, "vaed.col.no", "NO"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(32, 40, "vaed.col.title", "Ti\xEAu \u0111\u1EC1"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(35, 43, "vaed.col.applyPerson", "Ng\u01B0\u1EDDi xin ph\xE9p"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(38, 46, "vaed.col.updateDate", "Ng\xE0y th\u1EF1c hi\u1EC7n"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(41, 49, "vaed.col.affirmStatus", "Tr\u1EA1ng th\xE1i duy\u1EC7t"));
      \u0275\u0275advance(3);
      \u0275\u0275property("ngForOf", vaedTable_r15.data);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", !ctx.loading() && vaedTable_r15.data.length === 0);
      \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ViewApprovaledEmailComponent, [{
    type: Component,
    args: [{ selector: "app-view-approvaled-email", standalone: true, imports: [
      CommonModule,
      FormsModule,
      NzTableModule,
      NzCardModule,
  ...
  <div class="col-12">
    ...
    <nz-card class="mb-3">
      <form class="row g-3" (ngSubmit)="search()">
        <div class="col-md-4">
          <label class="form-label">{{ 'vaed.search.title' | translate:'Ti\xEAu \u0111\u1EC1' }}</label>
          <input nz-input [(ngModel)]="titleFilter" name="titleFilter">
        </div>
        <div class="col-md-3">
          <label class="form-label">{{ 'vaed.search.applyType' | translate:'Lo\u1EA1i \u0111\u01A1n' }}</label>
          <nz-select class="w-100" [(ngModel)]="applyTypeFilter" name="applyTypeFilter" nzAllowClear
                     [nzPlaceHolder]="'vaed.search.applyType.all' | translate:'-- T\u1EA5t c\u1EA3 --'">
        ...
        <div class="col-md-5 d-flex align-items-end justify-content-end gap-2 flex-wrap">
          <button nz-button nzType="primary" type="submit">
            <i class="bx bx-search"></i> {{ 'vaed.btn.search' | translate:'Tra c\u1EE9u' }}
          </button>
        </div>
      </form>
    </nz-card>
    ...
    <nz-card>
      ...
      <nz-table [nzData]="displayRows()" [nzLoading]="loading()" [nzPageSize]="25" [nzShowSizeChanger]="true"
                [nzPageSizeOptions]="pageSizeOptions" [nzShowTotal]="vaedTotalTpl" class="table-nowrap" #vaedTable>
        <thead>
          <tr>
            <th class="text-center" nzWidth="60px">{{ 'vaed.col.no' | translate:'NO' }}</th>
            <th>{{ 'vaed.col.title' | translate:'Ti\xEAu \u0111\u1EC1' }}</th>
            <th class="text-center" nzWidth="20%">{{ 'vaed.col.applyPerson' | translate:'Ng\u01B0\u1EDDi xin ph\xE9p' }}</th>
            <th class="text-center" nzWidth="12%">{{ 'vaed.col.updateDate' | translate:'Ng\xE0y th\u1EF1c hi\u1EC7n' }}</th>
            <th class="text-center" nzWidth="12%">{{ 'vaed.col.affirmStatus' | translate:'Tr\u1EA1ng th\xE1i duy\u1EC7t' }}</th>
          </tr>
        </thead>
        <tbody>
          <tr *ngFor="let row of vaedTable.data; let i = index">
          ...
          <tr *ngIf="!loading() && vaedTable.data.length === 0">
            <td colspan="5" class="text-center text-muted py-3">{{ 'vaed.msg.noData' | translate:'Kh\xF4ng c\xF3 d\u1EEF li\u1EC7u' }}</td>
          </tr>
        </tbody>
        <ng-template #vaedTotalTpl let-total>
...
` }]
  }], () => [{ type: ViewApprovaledEmailService }, { type: I18nService }, { type: NzMessageService }, { type: ActivatedRoute }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ViewApprovaledEmailComponent, { className: "ViewApprovaledEmailComponent", filePath: "src/app/view-approvaled-email/view-approvaled-email.component.ts", lineNumber: 87 });
})();
export {
  ViewApprovaledEmailComponent
};
//# debugId=b7399b97-7d5a-5705-b8fc-d9c993c7d03a
//# sourceMappingURL=chunk-O6X3N6PC.js.map
